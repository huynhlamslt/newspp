            ...
            <div class="row">
                <div class="col-12 col-lg-8">
                    <div class="blog-posts-area">
                        ...
                        <c:forEach var="c" items="${catepost}">
                        
                        <div class="single-blog-post featured-post mb-30">
                            <div class="post-thumb">
                                <a href="detail?idbaiviet=${c.idbaiviet}"><img src="${c.hinhanh }" alt="" style="height:353px; width:730px"></a>
                            </div>
                            <div class="post-data">
                                <a href="detail?idbaiviet=${c.idbaiviet}" class="post-title">
                                    <h6>${c.tuade}</h6>
                                </a>
                                <div class="post-meta">
                                    <p class="post-author">${c.ngayviet}</p>
                                    <p class="post-excerp">${c.tieude}</p>
                                    <!-- Post Like & Post Comment -->
                                    <div class="d-flex align-items-center">
                                        <a href="#" class="post-like"><img src="static/img/like.png" alt=""> <span>34</span></a>
                                        <a href="#" class="post-comment"><img src="static/img/chat.png" alt=""> <span>6</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
