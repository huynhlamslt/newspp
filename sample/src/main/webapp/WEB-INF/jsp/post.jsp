                    ...
                    <div class="blog-posts-area">
                        ...
                        <div class="single-blog-post featured-post single-post">
                            <div class="post-thumb" style="text-align: center">
                                <a href="" ><img src="${detail.hinhanh }" alt="" ></a>
                            </div>
                            <div class="post-data">
                                ...
                                <div class="post-meta">
                                    <p class="post-author">${detail.ngayviet }</p>
                                    
                                    <p style="font-size:16px">${detail.noidung } </p>
                                    <div class="newspaper-post-like d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="d-flex align-items-center post-like--comments">
                                            <a href="#" class="post-like"><img src="static/img/like.png" alt=""> <span>142</span></a>
                                            <a href="#" class="post-comment"><img src="static/img/chat.png" alt=""> <span>8</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <!-- Single Post -->
							<c:forEach var="re" items="${relate}">
								<div class="col-12 col-md-6">
									<div class="single-blog-post style-3 mb-80">
										<div class="post-thumb">
											<a href="detail?idbaiviet=${re.idbaiviet }"><img src="${re.hinhanh}" alt="" style="height:330px; width:330px "></a>
										</div>
										<div class="post-data">
											<a href="#"	class="post-title">
												<h6>${re.tuade }</h6>
											...
											<div class="post-meta d-flex align-items-center">
												<a href="#" class="post-like"><img
													src="static/img/like.png" alt=""> <span>120</span></a>
												<a href="#" class="post-comment"><img
													src="static/img/chat.png" alt=""> <span>10</span></a>
											</div>
										</div>
									</div>
								</div>
